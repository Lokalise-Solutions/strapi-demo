  ...
  return (
    ...
    >
      ...
      <div className="w-full ">
        ...
        >
          <div>{item.icon}</div>
          <motion.h2 className="max-w-md mt-2 font-display font-semibold text-2xl lg:text-4xl text-left text-brand-black">
            {item.title}
          </motion.h2>

          <motion.p className="text-lg text-muted font-normal max-w-sm mt-2">
            {item.description}
          </motion.p>
        </motion.div>
      </div>
    ...
    >
      ...
      <div className="w-full">
        <motion.div className=" mb-6">
          <div>{item.icon}</div>
          <motion.h2 className="mt-2 font-display font-semibold text-2xl lg:text-4xl text-left text-brand-black">
            {item.title}
          </motion.h2>

          <motion.p className="text-sm md:text-base text-muted font-normal max-w-sm mt-2">
            {item.description}
          </motion.p>
        </motion.div>
      </div>
